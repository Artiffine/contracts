...
export interface NFTContractBaseInterface extends utils.Interface {
  functions: {
...
export interface NFTContractBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFTContractBaseInterface;
