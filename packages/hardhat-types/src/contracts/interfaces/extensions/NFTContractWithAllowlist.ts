...
export interface NFTContractWithAllowlistInterface extends utils.Interface {
  functions: {
...
export interface NFTContractWithAllowlist extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFTContractWithAllowlistInterface;
