...
export interface INFTContractWithAllowlistInterface extends utils.Interface {
  functions: {
...
export interface INFTContractWithAllowlist extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: INFTContractWithAllowlistInterface;
