...
export interface NFTContractCrossmintInterface extends utils.Interface {
  functions: {
    ...
    "crossmint(address,uint8)": FunctionFragment;
...
export interface NFTContractCrossmint extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFTContractCrossmintInterface;
