...
export interface NFTContractExampleInterface extends utils.Interface {
  functions: {
...
export interface NFTContractExample extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: NFTContractExampleInterface
